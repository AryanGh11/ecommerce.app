...
> {
  ...
  render(): ReactNode {
    ...
    return (
      <button
        id={id}
        className={`w-full h-14 flex items-center px-4 border-primary border-solid border-[1.5px] rounded-full text-primary disabled:cursor-not-allowed [&:not(:disabled)]:hover:brightness-95 overflow-hidden text-ellipsis text-nowrap ${className} ${
